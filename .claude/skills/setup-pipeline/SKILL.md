---
name: setup-pipeline
description: Set up a fresh copy of this opportunity pipeline for a new student - virtualenv, .env, profile interview, sources, optional keys, first run, and one-click launcher. Use when someone asks to set up, install, configure, or personalize the pipeline, or when config/profile.json does not exist yet.
---
